...
import { Attachment } from "../samples/tradeSupportingDocumentsTemplateSample";
...
const buttonStyle = css`
  margin-top: 10px;
`;
export const ProofOfPaymentTemplate: FunctionComponent<TemplateProps<ProofOfPaymentTemplateCertificate> & {
  className?: string;
}> = ({ document, className = "" }) => {
